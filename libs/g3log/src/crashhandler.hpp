...
std::string exitReasonName(const LOGLEVEL& level, g2::SignalType signal_number);
...
void exitWithDefaultSignalHandler(const LOGLEVEL& level, g2::SignalType signal_number);
} // end g2::internal
